<?php
class ControllerModuleMultitable extends Controller {
	private $error = array();
	...
	public function index() {
		$this->document->setTitle('Multitable');
		...
		$this->data['breadcrumbs'] = $this->get_bread_crumbs('Multitable', 'multitable', $this->session->data['token']);

		$this->load->model('design/layout');

		$this->data['layouts'] = $this->model_design_layout->getLayouts();

		$this->template = 'module/multitable.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	private function validate() {
		if (!$this->user->hasPermission('modify', 'module/multitable')) {
