...
class ControllerModuleBlank extends Controller {
	...
	public function index() {
		...
		$this->data['breadcrumbs'] = $this->get_bread_crumbs('Blank', 'blank', $this->session->data['token']);

		$this->load->model('design/layout');

		$this->data['layouts'] = $this->model_design_layout->getLayouts();

		$this->template = 'module/blank.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	private function validate() {
		if (!$this->user->hasPermission('modify', 'module/blank')) {
